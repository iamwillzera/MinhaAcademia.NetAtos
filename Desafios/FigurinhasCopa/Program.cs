...
void cadastrarFigurinhaFaltante()
{
    string codigo;
    string selecao;
    string jogador;
    ...
    Console.WriteLine("Cadastrando figurinha faltante!");
    ...
    else
    {
        ...
        Util.gravarFigurinhaArquivo(figurinha, "faltantes.csv");
    }
}
...
do {
    ...
    switch (opcao) {
        case "1":
            ...
            break;
        case "2":
            cadastrarFigurinhaFaltante();        
            break;
        case "3":
            Util.mostrarListaFigurinhas(listaRepetidas,"minhasRepetidas.txt", "Repetidas");
            break;
        case "4":
            Util.mostrarListaFigurinhas(listaFaltantes, "minhasFaltantes.txt", "Faltantes");
            break;
        case "5":
            break;
        default:
